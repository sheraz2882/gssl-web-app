  ...
  return (
    <section className="rules-section">
      ...
      <ol className="rules-list">
        <li>
          ٹیم کیپٹن کے علاوہ اگر کوئی پلیئر امپائر سے شور/بحث کرے گا تو امپائر
          کے پاس پورا پورا پلنٹی دینے کا اختیار ہوگا۔
        </li>
        <li>
          انتظامیہ کی جانب سے دیئے گئے ٹائم پر اگر میچ شروع نہیں ہوا تو مزید 15
          منٹ دیے جائیں گےاگر ٹیم اس سے بھی لیٹ ہو جائے تو دوسری ٹیم کو پوائنٹ
          دیے جائیں گے۔
        </li>
        <li>
        ...
        <li>
          ڈرافٹنگ کے علاوہ اگر باہر سے کوئی پلیئر ٹیم میں کھیلے گا تو دوسری ٹیم
          کو پوائنٹ دے دیے جائیں گے۔
        </li>
        <li>
          شرٹس انتظامیہ (منیجمنٹ) کی جانب سے ہوں گی، اور تمام پلیئرز نے کالے رنگ
          کا ٹراؤزر لازمی پہننا ہوگا۔ کالے رنگ کے علاوہ کوئی بھی ٹراؤزر قابل
          قبول نہیں ہوگا۔
        </li>
        <li>
